...
public class winPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnAltaMedica = new javax.swing.JButton();
        ...
        btnAltaMedica.setBackground(new java.awt.Color(51, 51, 255));
        btnAltaMedica.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        btnAltaMedica.setForeground(new java.awt.Color(255, 255, 255));
        btnAltaMedica.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/formulario-de-contacto.png"))); // NOI18N
        btnAltaMedica.setText("Alta Médica");
        btnAltaMedica.setBorder(javax.swing.BorderFactory.createMatteBorder(1, -100, 1, 1, new java.awt.Color(0, 0, 0)));
        btnAltaMedica.setBorderPainted(false);
        btnAltaMedica.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnAltaMedica.setIconTextGap(10);
        btnAltaMedica.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAltaMedicaActionPerformed(evt);
            }
        });
        menu.add(btnAltaMedica, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 520, 260, 80));
    ...
    private void btnAltaMedicaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAltaMedicaActionPerformed
        AltaMedica am = new AltaMedica();
        panel(am);
    }//GEN-LAST:event_btnAltaMedicaActionPerformed
    ...
    private javax.swing.JButton btnAltaMedica;
